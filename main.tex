...
\usepackage[headings]{fancyhdr} %Headers and footers package$
...
\fancyhead[R]{PX3A2: Quantum Physics of Atoms}
\fancyhead[L]{Chris Cumming}
%\fancyfoot[L]{}
...
\noindent Throughout these notes are equations that are boxed. This is just to show that they are important results of that section but you don't necessarily have to remember them. If you do have to remember them I'll try to make that clear. Also I quite like using square brackets [~] to make equations look nicer compared to always using normal brackets (~) which might be confusing since this could also mean the commutator. Throughout the notes you should assume that [~] does mean commutator but I'll try to make it clear when they are not.
%\clearpage
%----------------------------------------------------------------------------------------
%	ACKNOWLEDGEMENTS
%----------------------------------------------------------------------------------------
